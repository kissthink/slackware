...
# stripslack.sh
#
# This script turns an existing Slackware Linux installation into StripSlack, a
# minimal console-only configuration with a collection of basic tools. It
# removes unneeded packages and installs needed ones. 
#
...
CRUFT=$(egrep -v '(^\#)|(^\s+$)' $CWD/pkglists/stripslack-remove)
INSTALL=$(egrep -v '(^\#)|(^\s+$)' $CWD/pkglists/stripslack-add)
...
echo
echo "+=============================================================================="
echo "| You are now running StripSlack 14.1."
echo "+=============================================================================="
echo
echo 
