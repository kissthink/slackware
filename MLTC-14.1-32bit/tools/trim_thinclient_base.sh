...
CRUFT=$(egrep -v '(^\#)|(^\s+$)' $CWD/pkglists/thinclient-base-remove)
INSTALL=$(egrep -v '(^\#)|(^\s+$)' $CWD/pkglists/thinclient-base-add)
...
echo
echo "+=============================================================================="
echo "| Your system is ready for building/installing MLTC 14.1."
echo "+=============================================================================="
echo
echo 
